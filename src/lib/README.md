...
- `schemas.ts` — `supportMessageSchema`/`SupportMessageInput` (category enum + 1-2000 char body) and `SUPPORT_CATEGORY_LABELS`, the shared Get-help validation/labels used by `actions/support.ts` and `components/support-form.tsx`
