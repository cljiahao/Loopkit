...
- `legal-check-state-schema.test.ts` — checks migration `0043_legal_check_state.sql` (`legal_check_state` table shape, RLS enabled with zero policies, `service_role`-only grant)
